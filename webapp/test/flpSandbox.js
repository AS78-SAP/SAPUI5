		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#asinvoicesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"asinvoicesinvoices-display": {
								"semanticObject": "asinvoicesinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=asinvoices.invoices",
									"url": sap.ui.require.toUrl("asinvoices/invoices")
								}
							}
						}
					}
